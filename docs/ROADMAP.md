...
- ~~Seed path: create a playable game (dev fixtures)~~ → built (SAN-54, split in SAN-61): `bootstrapDevLeague` mints an owner, two clubs, twenty players, and a scheduled game; `mintDevGame` appends further games from two club ids alone
